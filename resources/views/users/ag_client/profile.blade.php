        ...
        <div class="card user-profile o-hidden mb-4">
            ...
            <div class="card-body">
                <ul class="nav nav-tabs profile-nav mb-4" id="profileTab" role="tablist">
                    <li class="nav-item"><a class="nav-link active" id="timeline-tab" data-toggle="tab" href="#about" role="tab" aria-controls="timeline" aria-selected="false">Informations</a></li>
                    <li class="nav-item"><a class="nav-link" id="about-tab" data-toggle="tab" href="#order" role="tab" aria-controls="about" aria-selected="true">Commandes</a></li>
                ...
                <div class="tab-content" id="profileTabContent">
                        ...
                        <div class="col-md-12" style="margin-left: 80px;">
                            <div class="row">
                                <div class="col-md-4 col-6">
                                    <div class="mb-4">
                                        <p class="text-primary mb-1"><i class="i-Globe text-16 mr-1"></i> Adressse</p><span>Alger, Algérie</span>
                                    </div>
                                </div>
                                <div class="col-md-4 col-6">
                                    <div class="mb-4">
                                        <p class="text-primary mb-1"><i class="i-MaleFemale text-16 mr-1"></i> E-mail</p><span>example@ui-lib.com</span>
                                    </div>
                                </div>
                                <div class="col-md-4 col-6">
                                    <div class="mb-4">
                                        <p class="text-primary mb-1"><i class="i-Cloud-Weather text-16 mr-1"></i> Site web</p><span>www.ui-lib.com</span>
                                    </div>
                                </div>
                                <!--
                                <div class="col-md-4 col-6">
                    ...
                    <div class="tab-pane fade" id="order" role="tabpanel" aria-labelledby="about-tab">
